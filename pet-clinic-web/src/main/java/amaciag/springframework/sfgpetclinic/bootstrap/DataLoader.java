...
import amaciag.springframework.sfgpetclinic.services.map.OwnerServiceMap;
import amaciag.springframework.sfgpetclinic.services.map.VetServiceMap;
...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Vet vet2 = new Vet();
        vet1.setId(2l);
        vet1.setFisrtName("Max");
        vet1.setLastName("Sma");
